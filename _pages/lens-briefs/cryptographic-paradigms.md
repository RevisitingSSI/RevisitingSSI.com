...
* _**The Path to Self-Sovereign Identity**_ (2016). [article]. _Allen, Christopher._ Life With Alacrity. <https://www.lifewithalacrity.com/article/the-path-to-self-soverereign-identity/>

  > **WHY THIS MATTERS**: The original 10 SSI principles—to analyze what paradigm assumptions they embedded. Understanding what was assumed in 2016 reveals what we might unknowingly assume in 2026.

* _**Musings of a Trust Architect: Exodus Protocols**_ (2024). [article]. _Allen, Christopher._ Life With Alacrity. <https://www.lifewithalacrity.com/article/musings-exodus.protocol>
...
* _**Musings of a Trust Architect: Edge Identifiers & Cliques**_ (2024). [article]. _Allen, Christopher._ Life With Alacrity. <https://www.lifewithalacrity.com/article/cliques-1/>
...
* _**RFC 9591: The Flexible Round-Optimized Schnorr Threshold (FROST) Protocol**_ (2024). [standard]. _IETF._ <https://www.rfc-editor.org/rfc/rfc9591.html>
...
* _**Capability Myths Demolished**_ (2003). [paper]. _Miller, Yee, Shapiro._ <https://srl.cs.jhu.edu/pubs/SRL2003-02.pdf>

  > **WHY THIS MATTERS**: Foundational paper showing how paradigm assumptions (identity-first vs. capability-first) fundamentally shape what systems can do. Illustrates why paradigm awareness matters—ACL vs. capability thinking produces fundamentally different architectures.

* _**Failures of Public Key Infrastructure: 53 Year Survey**_ (2024). [paper]. _arXiv._ <https://arxiv.org/html/2401.05239v2>
