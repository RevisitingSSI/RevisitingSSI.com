...
The lenses are **complementary perspectives**, not competing views. Together they form a multi-layer architecture:

- **Protective constraints:** boundaries identity systems must not violate
- **Implementation mechanisms:** legal, technical, and governance tools enabling those protections
- **Compliance foundations:** methods for evaluating whether principles are upheld

Lenses frequently reference, critique, or refine one another to reveal interdependencies and blind spots.

## How to Read These Briefs

Each brief provides:
- A territory or focus of inquiry
- Why the lens matters for SSI
- Key harms, risks, and tensions
- Constructive directions to explore
- Cross-links to other lenses
- Open questions for community dialogue

Briefs will be developed by **Working Circles**—small groups (3-5 members) with diverse expertise who meet biweekly to explore their chosen lens. Outputs move toward rough consensus on worthy insights, not toward standards, specifications, or product designs.

## Proposing New Lenses

**Have you identified a lens we've missed?** We welcome proposals for new lenses that reveal unexplored dimensions of SSI's problem space—conceptual, ethical, legal, technical, or social perspectives that surface new harms, tensions, or constructive directions.

A new lens should:
- Clearly define the territory
- Explain its relevance to SSI's future
- Articulate harms or tensions
- Offer constructive directions
- Connect to existing lenses

See the [Template & Requirements](./template/) for structure and formatting guidelines.

## Get Involved

These briefs need you. Each lens is seeking a **primary author** or **Working Circle** to develop it further—bringing domain expertise, challenging assumptions, and refining the analysis through community dialogue.

**Ways to contribute:**
- **Lead a lens**: Take primary authorship of a brief that resonates with your expertise
- **Join a Working Circle**: Collaborate with 3-5 others on biweekly exploration
