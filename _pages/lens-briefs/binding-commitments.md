...
- **[Choice Architecture](../choice-architecture/)**: Examines structural lock-in where individually voluntary choices accumulate into permanent dependencies. This lens distinguishes productive constraints (chama membership with exit rights) from exploitative lock-in (platform vendor lock-in destroying accumulated value). Key insight: constraints aren't inherently harmful—design determines whether they enable cooperation or exploitation.

- **[Principal Authority](../principal-authority/)**: Addresses delegation relationships where agents owe enforceable duties. Binding commitments create different relationships—mutual obligations among peers (chama members), self-binding to overcome akrasia (Ulysses contracts), long-term coordination enabling planning. Both involve voluntary constraint, but agency law focuses on duty-bearing delegation while this lens focuses on credible commitment mechanisms.

- **[Right to Transact](../right-to-transact/)**: Protects participation rights—can you join credential networks without permission? This lens asks: once you've joined, what productive commitments enable trust and cooperation? Rights to participate combine with ability to commit credibly.

- **[Stewardship](../stewardship/)**: Addresses guardianship as special case of binding commitment with absolute power asymmetry. Parent-child guardianship is 18-year commitment relationship BUT lacks the characteristics of productive commitment: child didn't voluntarily join, has no negotiating power, cannot exit even if harmful, guardian's obligations are enforceable only through law not mutual stakes. Requires special calibration: this lens's productive vs. exploitative framework helps distinguish genuine care (empowerment, revocability, accountability) from exploitative control (permanent lock-in, no accountability, irrevocability).

Together: [Right to Transact](../right-to-transact/) (can you join?), this lens (can you commit?), [Choice Architecture](../choice-architecture/) (can you leave?), [Principal Authority](../principal-authority/) (what duties exist?), [Stewardship](../stewardship/) (how do commitments work when power is absolutely asymmetric?).
...
Current SSI architecture emphasizes four lenses on how [coercion harms](..//coercion-resistance.md) but gives minimal attention to when constraints are **valuable** rather than harmful. This lens provides needed balance: constraints aren't always harmful; binding commitments enable cooperation, trust, and autonomy—paradoxically—through self-limitation.
...
**Integration**: Works with [Choice Architecture](../choice-architecture/) (distinguishing productive constraint from lock-in), [Principal Authority](../principal-authority/) (balancing revocability with commitment value), [Right to Transact](../right-to-transact/) (participation rights + commitment ability). Together: participation rights + commitment mechanisms + exit rights + delegation duties = comprehensive framework enabling cooperation without exploitation.

#### **7. Selected Resources**

* _**The Identity Cycle**_ (2021). [book]. _Grigg, Ian._ <https://iang.org/identity_cycle/>

  > **WHY THIS MATTERS**: Demonstrates productive voluntary constraint through chamas—people voluntarily join structures with mutual obligations when mutual stakes, clear benefits, exit rights, and bounded context make constraint valuable rather than exploitative. Chamas work through: voluntary participation, mutual obligations (attendance, contributions), clear benefits (savings pools, community trust), exit rights (can leave but lose accumulated standing), bounded scope (obligations limited to group context). Exemplifies productive voluntary constraint—chosen commitments enabling cooperation by credibly constraining individual opportunism. Provides devastating critique of state IDs, corporate data systems, PKI as centralized authority claims. Proposes group-forming networks with "skin in the game" as foundation for digital identity.

* _**Ulysses and the Sirens: Studies in Rationality and Irrationality**_ (1979). [book]. _Elster, Jon._ Cambridge University Press.

  > **WHY THIS MATTERS**: Philosophical examination of self-binding and Ulysses contracts—how present-self constrains future-self to prevent anticipated failures of will, enabling rational long-term choices. Demonstrates that autonomy includes not just freedom of choice but freedom to constrain one's own future choices. Explores imperfect rationality, weakness of will, and strategic self-binding as essential human capacities. Foundation for understanding commitment devices enabling people to achieve long-term goals despite predictable failures of self-control.

* _**The Strategy of Conflict**_ (1960). [book]. _Schelling, Thomas._ Harvard University Press.

  > **WHY THIS MATTERS**: Game theory classic on credible commitments—how limiting your own future options creates strategic advantage by making commitments believable to others. "Burning bridges" and other commitment tactics enable coordination by credibly constraining future behavior. Shows commitment problems central to cooperation: without ability to bind yourself, others can't trust your promises. Strategic self-limitation creates credibility enabling trust, coordination, cooperation impossible with pure flexibility.

* _**Commitment Devices**_ (2010). [article]. _Bryan, Gharad; Karlan, Dean; Nelson, Scott._ Annual Review of Economics, Vol. 2, pp. 671-698.

  > **WHY THIS MATTERS**: Behavioral economics research on commitment devices—mechanisms enabling people to bind themselves to overcome present bias and achieve long-term goals. Empirical evidence that people actively seek commitment mechanisms to constrain future-self when present-self recognizes future failures of will. Examples: savings commitments, exercise contracts, smoking cessation devices. Shows demand for self-binding mechanisms across domains where present intentions conflict with anticipated future behavior.

#### **8. Open Questions & Questions for the Broader Community**

### Open Questions

1. **Commitment Enforcement**: Who enforces binding commitments in SSI? Technical protocols (time-locks, graduated costs), community governance (arbitration, reputation), legal systems (contracts, fiduciary duties), or pure social norms? What mix creates credibility without coercion?
