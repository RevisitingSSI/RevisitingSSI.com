...
- **[Irreducible Person](../irreducible-person/)**  
...
- **[Context Boundaries & Anti-Correlation](../context-boundaries/)**  
...
**Integration**: Works with [Principal Authority](../principal-authority/) (delegation not sale), [Multi-Scalar Sovereignty](../multi-scalar-sovereignty/) (collective governance not individual ownership), [Relational Autonomy](../relational-autonomy/) (identity through connection not possession). Together: dismantle property thinking + replace with agency framework + ground in relational philosophy + recognize collective sovereignty = comprehensive anti-commodification framework.

#### **7. Selected Resources**

* _**Beyond Data: Reclaiming Human Rights at the Dawn of the Metaverse**_ (2021). [book]. _Renieris, Elizabeth M._ MIT Press.

  > **WHY THIS MATTERS**: Comprehensive critique of "data ownership" frameworks, arguing property models extend surveillance capitalism's broken logic to all identity contexts. "Data" discourse distracts from human rights violations by reducing people to information assets. Property frameworks legitimize extraction—platforms don't violate rights, they purchase "owned" data through adhesion contracts. Calls for grounding digital identity in human rights law (dignity, autonomy, non-discrimination) rather than property law (ownership, alienability, markets).

* _**Contested Commodities**_ (1996). [book]. _Radin, Margaret Jane._ Harvard University Press.

  > **WHY THIS MATTERS**: Establishes market-inalienability theory—some things too bound up with personhood to commodify. Certain goods so connected to personhood that commodifying them is harmful even if "voluntary": body parts, reproductive capacity, personhood attributes. Universal commodification degrades human flourishing. Application to identity: biometric data, medical histories, political beliefs are constitutive of personhood and shouldn't be tradeable commodities.

* _**Whiteness as Property**_ (1993). [law review article]. _Harris, Cheryl I._ 106 Harvard Law Review 1707.

  > **WHY THIS MATTERS**: Property law historically encoded racial hierarchies—whiteness functioned as property granting access, opportunity, protection. Through slavery and its aftermath, whiteness became form of property in U.S. law—conferring rights, privileges, legal protection denied to non-whites. Property law actively constructed racial hierarchies through exclusion, subordination, legitimation of inequality. Warning for digital identity: treating identity as property risks encoding similar exclusions through algorithmic systems using data to reproduce discrimination.

* _**Between Truth and Power: The Legal Constructions of Informational Capitalism**_ (2019). [book]. _Cohen, Julie E._ Oxford University Press.

  > **WHY THIS MATTERS**: Demonstrates how code and law co-construct identity as extractable capital. Property frameworks don't just describe data—they actively create it as commodity. Legal frameworks and technical architectures work together to construct personal data as capital for surveillance capitalism. "Code" (technical architecture) and "law" (legal frameworks) have "fractal effects"—shaping what's possible, who benefits, how reality is understood. Alternative: recognize law's constitutive role and redesign frameworks to protect personhood rather than commodification.

* _**The Illusion of Personal Data as No One's Property**_ (2017). [law review article]. _Purtova, Nadezhda._ 7 European Journal of Law and Technology.

  > **WHY THIS MATTERS**: "No one owns data" is illusion—corporations already claim quasi-property rights through database rights, trade secrets, contractual assignments, terms of service. Platforms hold enforceable legal claims functioning as property. Giving individuals "data ownership" doesn't challenge existing claims—it validates property framework where corporations have structural advantages. Individual ownership is illusory control legitimizing extraction. Warning: property thinking itself is the problem, not who holds property rights.

* _**Privacy in Context: Technology, Policy, and the Integrity of Social Life**_ (2009). [book]. _Nissenbaum, Helen._ Stanford Law Books.

  > **WHY THIS MATTERS**: Contextual integrity framework: information flows must match social context norms, not blanket ownership rules. Privacy is **contextual**—information appropriate in one setting (medical, financial, familial) is inappropriate in another. Social norms govern information flows. Property thinking enables context collapse: "you own this data, license it anywhere." Contextual integrity requires information flows match norms, aggregation across contexts is limited, social roles carry specific obligations. Alternative to ownership: context-appropriate governance.
