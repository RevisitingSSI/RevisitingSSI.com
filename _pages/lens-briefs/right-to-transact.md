...
- **[Principal Authority](../principal-authority/)**: Addresses duties WHEN you delegate. This lens asks prior question: Can you participate in credential systems without being blocked? Participation rights must exist before delegation duties matter—can't delegate if excluded from participating.

- **[Binding Commitments](../binding-commitments/)**: Addresses credible commitments enabling trust. This lens asks: Can you join commitment systems (chamas, mutual aid networks) without needing permission? Freedom of association protects forming commitment groups; right to transact enables peer exchange within groups.

- **[Multi-Scalar Sovereignty](../multi-scalar-sovereignty/)**: Addresses sovereignty at multiple scales. This lens provides constitutional grounding: freedom of assembly/association protect forming groups at any scale without permission.

- **[Relational Autonomy](../relational-autonomy/)**: Provides **relationship-aware architecture** for community credentials. This lens establishes constitutional right to form communities and issue credentials without permission; Relational Autonomy provides technical mechanisms (bilateral consent, edge identifiers, community attestations) enabling those community credentials. Example: Freedom of association protects forming chamas, but without relationship primitives, chamas can't issue membership credentials proving trustworthiness. Together: participation rights (this lens) + relationship architecture (Relational Autonomy) = community credential issuance becomes technically and legally viable.
...
**Integration**: Works with [Principal Authority(..principal-authority/) (establishes duties WHEN you delegate), [Binding Commitments](../binding-commitments/) (enables productive constraint AFTER joining), [Multi-Scalar Sovereignty](../multi-scalar-sovereignty/) (addresses sovereignty AT all scales). Together: participation rights (this lens) + delegation duties + productive commitments + multi-scalar governance = comprehensive framework.

#### **7. Selected Resources**

* _**Operation Choke Point 2.0: How U.S. Regulators Are Covertly De-Banking Crypto**_ (2023). [article]. _Grewal, Nik._ Coindesk. <https://www.coindesk.com/consensus-magazine/2023/03/10/operation-choke-point-20-how-us-regulators-are-covertly-de-banking-crypto/>

  > **WHY THIS MATTERS**: Documents financial de-platforming pattern—banks close accounts for legal businesses following regulatory pressure. Pattern: pressure intermediaries → intermediaries comply → individuals excluded without recourse. Warning for SSI: wallet providers could exclude "risky" users (activists, journalists, politically disfavored) through similar mechanisms. Constitutional protections needed.

* _**Universal Declaration of Human Rights** (Article 20: Freedom of Assembly & Association)_ (1948). [treaty]. _United Nations._

  > **WHY THIS MATTERS**: Establishes freedom of peaceful assembly and association as fundamental human rights. Provides international legal grounding for digital identity participation rights—forming credential networks, issuing community attestations, participating in peer verification are protected assembly/association activities. No platform/government can prohibit without compelling justification.

* _**Citizens United v. Federal Election Commission**_ (2010). [Supreme Court case]. _U.S. Supreme Court._ 558 U.S. 310.

  > **WHY THIS MATTERS**: Establishes freedom of association protects forming organizations and participating in collective activities without government permission. Applied to SSI: forming chamas, mutual aid networks, grassroots credentialing organizations protected activities. Government cannot mandate centralized ID eliminating peer alternatives without violating association rights.

* _**Cash and Freedom**_ (2020). [paper]. _Rogoff, Kenneth._ Project Syndicate. <https://www.project-syndicate.org/commentary/cash-freedom-privacy-surveillance-by-kenneth-rogoff-2020-12>

  > **WHY THIS MATTERS**: Analyzes cash transactions as model for peer-to-peer exchange without intermediary approval or surveillance. Right to transact without requiring permission from banks, payment networks, or governments. Provides foundation for peer-to-peer credential exchange rights—like cash, credentials should be exchangeable between consenting parties without platform gatekeeping.

* _**Crypto's 'Freedom to Transact' May Actually Threaten Human Rights**_ (2022). [article]. _Renieris, Elizabeth M._ Centre for International Governance Innovation (CIGI). <https://www.cigionline.org/articles/cryptos-freedom-to-transact-may-actually-threaten-human-rights/>

  > **WHY THIS MATTERS**: Renieris warns that expansive or absolutist interpretations of a "right to transact" can undermine legitimate regulatory interests and public protections. Her critique highlights the need to distinguish between proportionate oversight and exclusionary gatekeeping—reinforcing this lens's focus on preventing transactional controls from being used to restrict participation rather than precluding all regulation.
